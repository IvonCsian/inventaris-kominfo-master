                        ...
                        <form class="forms-sample" action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="merk" value="{{ old('merk') }}" class="form-control @error('merk') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Muatan">
                                      @error('merk')
                                      <small class="text-danger" style="font-size: 12px">
                                          {{ $message }}.
                                      </small>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bahan" value="{{ old('bahan') }}" class="form-control @error('bahan') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Kondisi Kendaraan">
                                          @error('bahan')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ukuran" value="{{ old('ukuran') }}" class="form-control @error('ukuran') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Kondisi Kendaraan">
                                          @error('ukuran')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="asal_barang" value="{{ old('asal_barang') }}" class="form-control @error('asal_barang') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Kondisi Kendaraan">
                                          @error('asal_barang')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kondisi_barang" value="{{ old('kondisi_barang') }}" class="form-control @error('kondisi_barang') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Kondisi Kendaraan">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jumlah_barang" value="{{ old('jumlah_barang') }}" class="form-control @error('jumlah_barang') is-invalid @enderror" id="exampleInputUsername1" placeholder="Masukkan Jumlah Penumpang">
                                          @error('jumlah_barang')
                                          <small class="text-danger" style="font-size: 12px">
                                              {{ $message }}.
                                          </small>
